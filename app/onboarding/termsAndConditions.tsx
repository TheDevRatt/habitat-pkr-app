      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          ...
          <Text style={styles.content}>
            ...
            controlled or licensed by or to Company, and is protected by trade
            ...
            INABILITY TO USE THE MATERIALS ON THE WEBSITE, EVEN IF THE WEBSITE
            ADMINISTRATOR OR AN AUTHORIZED REPRESENTATIVE HAS BEEN NOTIFIED
