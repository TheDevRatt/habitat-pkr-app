    ...
    >
      <SafeAreaView className="flex-1 items-center">
        ...
        <View className="items-center w-50">
          ...
          {/** Okay so the drivers license svg file is formatted strangely, I've
          had to apply negative margins to get it to fit. */}
          <DriversLicenseLogo className="mt-[-50px] mb-[-50px]" />
